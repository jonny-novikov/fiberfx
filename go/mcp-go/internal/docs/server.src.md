...
[`ClientSession.Prompts`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.Prompts)
iterator, or the lower-level
[`ClientSession.ListPrompts`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.ListPrompts)
(see [pagination](#pagination) below). Set
[`ClientOptions.PromptListChangedHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.PromptListChangedHandler)
to be notified of changes in the list of prompts.

Call
[`ClientSession.GetPrompt`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.GetPrompt)
to retrieve a prompt by name, providing arguments for expansion. 

**Server-side**: Use
[`Server.AddPrompt`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Server.AddPrompt)
...
[`ServerOptions.HasPrompts`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.HasPrompts)
...
**Client-side**:
Call [`ClientSession.ReadResource`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.ReadResource)
to read a resource.
...
[`ClientSession.Resources`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.Resources)
and
[`ClientSession.ResourceTemplates`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.ResourceTemplates)
iterators, or the lower-level `ListXXX` calls (see [pagination](#pagination)).
Set
[`ClientOptions.ResourceListChangedHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.ResourceListChangedHandler)
...
Call
[`ClientSession.Subscribe`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.Subscribe)
to subscribe to a resource
and
[`ClientSession.Unsubscribe`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.Unsubscribe)
to unsubscribe.
Set
[`ClientOptions.ResourceUpdatedHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.ResourceUpdatedHandler)
to be notified of changes to subscribed resources.

**Server-side**:
Use
[`Server.AddResource`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Server.AddResource)
or
[`Server.AddResourceTemplate`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Server.AddResourceTemplate)
to add a resource or resource template to the server along with its handler.
A
[`ResourceHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ResourceHandler)
...
server is connected to a client, or if
[`ServerOptions.HasResources`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.HasResources)
is explicitly set. When a prompt is added, any clients already connected to the
...
[`ClientSession.Tools`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.Tools)
iterator, or the lower-level
[`ClientSession.ListTools`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.ListTools)
(see [pagination](#pagination)). Set
[`ClientOptions.ToolListChangedHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.ToolListChangedHandler)
to be notified of changes in the list of tools.

To call a tool, use
[`ClientSession.CallTool`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.CallTool)
...
[`Server.AddTool`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Server.AddTool)
adds a
[`Tool`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Tool) to
the server along with its
[`ToolHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ToolHandler)
...
[`ServerOptions.HasTools`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.HasPrompts)
...
[`AddTool`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#AddTool)
...
_See [mcp/tool_example_test.go](https://github.com/fiberfx/mcp-go/blob/main/mcp/tool_example_test.go) for the full
example, or [examples/server/toolschemas](https://github.com/fiberfx/mcp-go/blob/main/examples/server/toolschemas/main.go)
...
[`SchemaCache`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#SchemaCache)
...
[`ClientSession.Complete`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.Complete)
method.

**Server-side**: completion is enabled by setting
[`ServerOptions.CompletionHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.CompletionHandler).
...
[`ServerSession.Log`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerSession.Log) is the low-level way for servers to log to clients.
It sends a logging notification to the client if the level of the message
is at least the minimum log level.

For a simpler API, use [`NewLoggingHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#NewLoggingHandler) to obtain a [`slog.Handler`](https://pkg.go.dev/log/slog#Handler).
By setting [`LoggingHandlerOptions.MinInterval`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#LoggingHandlerOptions.MinInterval), the handler can be rate-limited
...
**Client-side**:
Set [`ClientOptions.LoggingMessageHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.LoggingMessageHandler) to receive log messages.

Call [`ClientSession.SetLevel`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.SetLevel) to change the log level for a session.
...
[`ServerOptions.Capabilities`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.Capabilities).
...
- [`ClientSession.Prompts`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.Prompts)
  iterates prompts.
- [`ClientSession.Resource`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.Resource)
  iterates resources.
- [`ClientSession.ResourceTemplates`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.ResourceTemplates)
...
[`ServerOptions.PageSize`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.PageSize)
