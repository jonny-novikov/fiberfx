...
In this SDK, both a
[`Client`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Client)
and
[`Server`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Server)
...
- A `Client` is a logical MCP client, configured with various
  [`ClientOptions`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions).
- When a client is connected to a server using
  [`Client.Connect`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Client.Connect),
  it creates a
  [`ClientSession`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession).
...
- A `Server` is a logical MCP server, configured with various
  [`ServerOptions`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions).
- When a server is connected to a client using
  [`Server.Connect`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Server.Connect),
  it creates a
  [`ServerSession`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerSession).
...
[`Transport`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Transport)
...
[`CommandTransport`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#CommandTransport),
...
[`StdioTransport`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#StdioTransport),
...
[#580](https://github.com/fiberfx/mcp-go/issues/580)).
...
[`StreamableHTTPOptions.Stateless`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#StreamableHTTPOptions.Stateless),
...
_See [examples/server/distributed](https://github.com/fiberfx/mcp-go/blob/main/examples/server/distributed/main.go) for
...
_Full example: [examples/server/custom-transport](https://github.com/fiberfx/mcp-go/blob/main//examples/server/custom-transport/main.go)._
...
See
[modelcontextprotocol/go-sdk#26](https://github.com/fiberfx/mcp-go/issues/26)
for more background.
...
use [`RequireBearerToken`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#RequireBearerToken).
This function is middleware that wraps an HTTP handler, such as the one returned
by [`NewStreamableHTTPHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#NewStreamableHTTPHandler), to provide support for verifying bearer tokens.
The middleware function checks every request for an Authorization header with a bearer token,
and invokes the 
[`TokenVerifier`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#TokenVerifier)
...
[`RequireBearerTokenOptions.Scopes`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#RequireBearerTokenOptions.Scopes)), so the
`TokenVerifier` doesn't have to.
If [`RequireBearerTokenOptions.ResourceMetadataURL`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#RequireBearerTokenOptions.ResourceMetadataURL) is set and verification fails, 
...
[`CallToolRequest`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#CallToolRequest).)
HTTP handlers wrapped by the `RequireBearerToken` middleware can obtain the `TokenInfo` from the context
with [`auth.TokenInfoFromContext`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#TokenInfoFromContext).
...
The SDK provides [`ProtectedResourceMetadataHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#ProtectedResourceMetadataHandler)
...
The  [_auth middleware example_](https://github.com/fiberfx/mcp-go/tree/main/examples/server/auth-middleware) shows how to implement authorization for both JWT tokens and API keys.

### Client

Client-side authorization is supported via the
[`StreamableClientTransport.OAuthHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#StreamableClientTransport.OAuthHandler)
...
[`auth.AuthorizationCodeHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#AuthorizationCodeHandler).
...
the SDK provides
[`extauth.EnterpriseHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth/extauth#EnterpriseHandler),
...
For a complete working example, see [examples/auth/enterprise](https://github.com/fiberfx/mcp-go/tree/main/examples/auth/enterprise).
...
[`TokenVerifier`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#TokenVerifier)
provided to 
[`RequireBearerToken`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#RequireBearerToken).
...
- _Verify all inbound requests_. The [`RequireBearerToken`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#RequireBearerToken)
...
[`ServerOptions.GetSessionID`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.GetSessionID), it is your responsibility to ensure they are secure.
...
[`TokenInfo.UserID`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#TokenInfo.UserID).
When a [`TokenVerifier`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth#TokenVerifier)
...
[`ClientSession.Ping`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.Ping)
or
[`ServerSession.Ping`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerSession.Ping).

To have the client or server session automatically ping its peer, and close the
session if the ping fails, set
[`ClientOptions.KeepAlive`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.KeepAlive)
or
[`ServerOptions.KeepAlive`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.KeepAlive).
...
calling either
[`ClientSession.NotifyProgress`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientSession.NotifyProgress)
or
[`ServerSession.NotifyProgress`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerSession.NotifyProgress).
To listen to progress notifications, set
[`ClientOptions.ProgressNotificationHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.ProgressNotificationHandler)
or
[`ServerOptions.ProgressNotificationHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.ProgressNotificationHandler).
