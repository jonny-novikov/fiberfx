...
[`Client.AddRoots`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Client.AddRoots)
and
[`Client.RemoveRoots`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#Client.RemoveRoots)
...
[`ServerSession.ListRoots`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerSession.ListRoots)
method. To receive notifications about root changes, set
[`ServerOptions.RootsListChangedHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerOptions.RootsListChangedHandler).
...
[`ClientOptions.CreateMessageHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.CreateMessageHandler).
This function is invoked whenever the server requests sampling.

**Server-side**: To use sampling from the server, call
[`ServerSession.CreateMessage`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerSession.CreateMessage).
...
[`ClientOptions.ElicitationHandler`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.ElicitationHandler).
...
[`ServerSession.Elicit`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ServerSession.Elicit).
...
documentation](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientCapabilities)
...
[`ClientOptions.Capabilities`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp#ClientOptions.Capabilities).
