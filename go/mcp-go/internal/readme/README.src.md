...
IMPORTANT: This repository contains Research Preview implementation of the official Go software
development kit (SDK) for the Model Context Protocol (MCP) to future integration into official package with updated licensing.
...
- The
  [`github.com/fiberfx/mcp-go/v2/mcp`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/mcp)
  package defines the primary APIs for constructing and using MCP clients and
  servers.
- The
  [`github.com/fiberfx/mcp-go/v2/jsonrpc`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/jsonrpc) package is for users implementing
  their own transports.
- The
  [`github.com/fiberfx/mcp-go/v2/auth`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/auth)
  package provides some primitives for supporting OAuth.
- The
  [`github.com/fiberfx/mcp-go/v2/oauthex`](https://pkg.go.dev/github.com/fiberfx/mcp-go/v2/oauthex)
