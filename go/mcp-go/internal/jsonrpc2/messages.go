...
//
// settled(aaw): ID can't be a json.Marshaler/Unmarshaler while omitzero
// support is required; making ID json-serializable awaits upstream, and the
// coercion here is kept as-is.
...
// settled(aaw, upstream rfindley): indent handling stays inline; an
// encoder-passing refactor is an upstream design question, not pursued in
// this fork.
