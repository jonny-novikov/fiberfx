...
//
// settled(aaw, upstream rfindley): a framer-interface rethink (correlated
// Reader/Writer, e.g. Frame(io.ReadWriteCloser) (Reader, Writer), as needed
// for JSONRPC2 batching) is an upstream design debate; not pursued in this
// fork.
