...
type (
	...
	ProgressNotificationServerRequest = ServerRequest[*ProgressParams]
...
type (
	...
	ProgressNotificationClientRequest      = ClientRequest[*ProgressParams]
	...
	ResourceUpdatedNotificationRequest     = ClientRequest[*ResourceUpdatedParams]
