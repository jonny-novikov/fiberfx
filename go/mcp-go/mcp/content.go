...
// settled(aaw, upstream findleyr): only text content preserves required fields
// in JSON marshalling (see [TextContent.MarshalJSON]); extending this to all
// content types is upstream work, not pursued in this fork.
