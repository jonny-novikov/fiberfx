...
// See [/specification/2025-11-25/basic/index#icons] for notes on icons
type Icon struct {
...
// settled(aaw): capability-type ordering stays as-is (ServerCapabilities
// groups its types differently); code-motion churn not pursued in this fork.
...
// settled(aaw, upstream jba): CompleteRequest and related types remain
// unadded upstream work; not pursued in this fork.
