...
// settled(aaw): stays unexported; exporting this type and its field is an
// upstream API-surface question, not pursued in this fork.
...
func (cs *ClientSession) Close(ctx context.Context) error {
...
//
// settled(aaw, upstream rfindley): stays unexported (not strictly necessary
// for the SEP); an export proposal is upstream work, not pursued in this fork.
...
func (cs *ClientSession) callProgressNotificationHandler(ctx context.Context, params *ProgressParams) (Result, error) {
