...
| `exchange` · `investex` · `echo_bot` · `codemoji` | Consumers / standalone (trading capstone · venue gRPC client · YAML multibot engine · the demo). Out of scope for the BCS data-stack build guide.                                                                                                     | various |
