...
| F6.2–F6.9 | The remaining Phoenix arc above the preserved boundary, then deploy. The domain, ids, store, and engine boundary are **preserved** — nothing below the boundary changes. | planned |
