# Codemojex Currency Model

## What are the three currencies in Codemojex?

Codemojex uses a three-currency economy. Each currency serves a distinct role in the game loop:
