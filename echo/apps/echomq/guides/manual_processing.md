...
EchoMQ Elixir supports manual job processing, where you have full control over fetching jobs and managing their lifecycle instead of using automatic worker processing.
...
The Elixir API closely mirrors the Node.js EchoMQ manual processing API:
