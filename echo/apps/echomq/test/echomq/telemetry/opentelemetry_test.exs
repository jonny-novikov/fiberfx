defmodule EchoMQ.Telemetry.OpenTelemetryTest do
  use ExUnit.Case, async: true

  alias EchoMQ.Telemetry.OpenTelemetry
  ...
  describe "context serialization" do
    ...
    test "deserialize_context handles Node.js echomq-otel format" do
      # This is the format produced by Node.js echomq-otel:
