...
# EchoMQ Elixir Benchmark
#
# This script benchmarks EchoMQ throughput at different concurrency levels.
#
# Usage:
#   cd elixir
...
defmodule EchoMQ.Benchmark do
  @moduledoc """
  Benchmark EchoMQ throughput at various concurrency levels.
  Produces tabular data suitable for articles and comparisons.
  """

  alias EchoMQ.{Queue, Worker, RedisConnection, Keys}
  ...
  def run(opts \\ []) do
    ...
    ╔═══════════════════════════════════════════════════════════════╗
    ║           EchoMQ Elixir Throughput Benchmark                  ║
    ╚═══════════════════════════════════════════════════════════════╝
...
EchoMQ.Benchmark.run(jobs: jobs, concurrencies: concurrencies, job_duration: job_duration, workers: workers)
