...
[![Hex.pm](https://img.shields.io/hexpm/v/echomq.svg)](https://hex.pm/packages/echomq)
[![Hex.pm](https://img.shields.io/hexpm/dt/echomq.svg)](https://hex.pm/packages/echomq)
[![Documentation](https://img.shields.io/badge/docs-hexpm-blue.svg)](https://hexdocs.pm/echomq)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/taskforcesh/bullmq/blob/master/LICENSE)

A powerful, fast, and robust job queue for Elixir backed by Redis. Part of the [EchoMQ](https://github.com/taskforcesh/bullmq) polyglot message queue protocol, providing full wire compatibility with Node.js BullMQ queues and Go EchoMQ workers.
...
Add `echomq` to your list of dependencies in `mix.exs`:
...
Full documentation is available at [HexDocs](https://hexdocs.pm/echomq).

- [Getting Started](https://hexdocs.pm/echomq/getting_started.html)
- [Workers](https://hexdocs.pm/echomq/workers.html)
- [Job Options](https://hexdocs.pm/echomq/job_options.html)
- [Queue Events](https://hexdocs.pm/echomq/queue_events.html)
- [Rate Limiting](https://hexdocs.pm/echomq/rate_limiting.html)
- [Job Schedulers](https://hexdocs.pm/echomq/job_schedulers.html)
- [Telemetry](https://hexdocs.pm/echomq/telemetry.html)
...
This library is fully wire-compatible with the Node.js BullMQ library and Go EchoMQ workers. Jobs can be added from any language and processed by workers in any other language. All implementations share the same Redis data structures and Lua scripts (the EchoMQ protocol).
...
EchoMQ is part of the polyglot EchoMQ protocol, based on [BullMQ](https://bullmq.io) by [Taskforce.sh](https://taskforce.sh).
