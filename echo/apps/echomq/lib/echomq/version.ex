defmodule EchoMQ.Version do
  @moduledoc """
  EchoMQ version information.

  This module contains the EchoMQ version that corresponds to the Lua scripts
  ...
  **Important:** This version tracks the Lua script compatibility with the
  Node.js EchoMQ library, NOT the Elixir package version. The Elixir package
  version is defined in `mix.exs` and can evolve independently on Hex.pm.

  ## How it works

  When a Queue or Worker interacts with Redis, the EchoMQ version is stored
  ...
  # The EchoMQ version corresponding to the Lua scripts.
  # This should match the Node.js EchoMQ version that the Lua scripts
  # in `priv/scripts/` are sourced from.
  @bullmq_version "5.65.1"

  @doc """
  Returns the EchoMQ version string.

  ## Examples

      iex> EchoMQ.Version.version()
      "5.65.1"
  """
  ...
  ## Examples
      ...
      iex> EchoMQ.Version.full_version()
      "bullmq:5.65.1"
  """
