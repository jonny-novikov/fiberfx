defmodule EchoMQ.RedisConnection do
  @moduledoc """
  Redis connection management for EchoMQ.
  ...
  Then use it with queues and workers:
      ...
      EchoMQ.Queue.add("my_queue", "job", %{}, connection: :echomq_redis)
  ...
  ## Examples
      ...
      EchoMQ.RedisConnection.command(:my_redis, ["SET", "key", "value"])
      #=> {:ok, "OK"}

      EchoMQ.RedisConnection.command(:my_redis, ["GET", "key"])
      #=> {:ok, "value"}
  """
  ...
  ## Examples
      ...
      EchoMQ.RedisConnection.pipeline(:my_redis, [
        ["SET", "key1", "value1"],
        ["SET", "key2", "value2"],
        ["GET", "key1"]
      ])
  ...
  ## Examples
      ...
      EchoMQ.RedisConnection.transaction(:my_redis, [
        ["SET", "key1", "value1"],
        ["SET", "key2", "value2"],
        ["GET", "key1"]
      ])
  ...
  ## Examples
      ...
      EchoMQ.RedisConnection.eval(:my_redis, "return KEYS[1]", ["mykey"], [])
      #=> {:ok, "mykey"}
  """
