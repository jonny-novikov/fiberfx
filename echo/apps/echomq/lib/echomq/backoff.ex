defmodule EchoMQ.Backoff do
  ...
  EchoMQ supports various backoff strategies to control the delay between
  ...
  This is automatically started by the EchoMQ application.
  """
  ...
  ## Examples
      ...
      EchoMQ.Backoff.register(:custom, fn attempt, delay, error, job ->
        case error do
  ...
  ## Examples
      ...
      EchoMQ.Backoff.calculate(:fixed, 3, 1000)
      #=> 1000

      EchoMQ.Backoff.calculate(:exponential, 3, 1000)
      #=> 4000

      EchoMQ.Backoff.calculate(:exponential, 3, 1000, jitter: 0.2)
  ...
  ## Examples
      ...
      EchoMQ.Backoff.calculate_from_config(config, 3)
      #=> ~4000
  """
