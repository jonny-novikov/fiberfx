defmodule EchoMQ.Types do
  @moduledoc """
  Type definitions for EchoMQ.

  This module defines the core types used throughout the EchoMQ library.
  All types are designed to be compatible with the Node.js EchoMQ library.
  """
