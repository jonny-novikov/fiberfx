defmodule EchoMQ.Keys do
  @moduledoc """
  Redis key generation for EchoMQ queues.

  This module generates consistent Redis keys following the EchoMQ naming convention.
  All keys follow the pattern: `{prefix}:{queue_name}:{key_type}`.

  The default prefix is "bull" for compatibility with the Node.js EchoMQ library.
  """
  ...
  ## Examples
      ...
      iex> EchoMQ.Keys.context("bull", "my_queue")
      %{prefix: "bull", name: "my_queue"}

      iex> EchoMQ.Keys.context("my_queue")
      %{prefix: "bull", name: "my_queue"}
  """
  ...
  ## Examples
      ...
      iex> EchoMQ.Keys.new("my_queue")
      %{prefix: "bull", name: "my_queue"}

      iex> EchoMQ.Keys.new("my_queue", prefix: "myapp")
  ...
  ## Examples
      ...
      iex> ctx = EchoMQ.Keys.new("my_queue")
      iex> EchoMQ.Keys.key(ctx)
      "bull:my_queue"
  """
  ...
  ## Examples
      ...
      iex> ctx = EchoMQ.Keys.new("my_queue")
      iex> EchoMQ.Keys.key_prefix(ctx)
      "bull:my_queue:"
  """
  ...
  ## Examples
      ...
      iex> EchoMQ.Keys.parse_job_id("bull:my_queue:123")
      "123"
  """
  ...
  ## Examples
      ...
      iex> EchoMQ.Keys.parse_job_key("bull:my_queue:123")
