defmodule EchoMQ.Scripts do
  @moduledoc """
  Manages Lua scripts for EchoMQ Redis operations.
  ...
  alias EchoMQ.{Keys, RedisConnection}
  ...
  ## Examples
      ...
      iex> {content, keys} = EchoMQ.Scripts.get(:extend_lock)
  ...
  # Normalize keep_jobs to EchoMQ format
  ...
  # Pack job options using msgpack with EchoMQ's compressed option names
  ...
  def pack_job_opts(job, additional_opts \\ %{}) do
    ...
    # Build options map with EchoMQ's short key names
    opts =
      %{}
