defmodule EchoMQ.Queue do
  ...
  For more control, you can start a Queue as a supervised process:
      ...
      children = [
        {EchoMQ.Queue, name: :my_queue, queue: "my_queue", connection: :my_redis}
      ]
  ...
  ## Queue Operations
      ...
      # Pause the queue
      :ok = EchoMQ.Queue.pause("my_queue", connection: :my_redis)

      # Resume the queue
      :ok = EchoMQ.Queue.resume("my_queue", connection: :my_redis)

      # Get queue counts
      {:ok, counts} = EchoMQ.Queue.get_counts("my_queue", connection: :my_redis)
      # %{waiting: 10, active: 2, delayed: 5, completed: 100, failed: 3}

      # Drain the queue (remove all waiting jobs)
      :ok = EchoMQ.Queue.drain("my_queue", connection: :my_redis)
  """

  use GenServer

  alias EchoMQ.{Job, Keys, RedisConnection, Scripts, Types, Version}
  ...
  @opts_schema NimbleOptions.new!(
                 ...
                 telemetry: [
                   ...
                   default: nil,
                   doc:
                     "Module implementing `EchoMQ.Telemetry.Behaviour` for distributed tracing (e.g., `EchoMQ.Telemetry.OpenTelemetry`)."
                 ],
                 skip_meta_update: [
                   type: :boolean,
                   default: false,
  ...
  ## Examples
      ...
      # Add a simple job
      {:ok, job} = EchoMQ.Queue.add("emails", "welcome", %{user_id: 123},
        connection: :redis)

      # Add a delayed job
      {:ok, job} = EchoMQ.Queue.add("emails", "reminder", %{user_id: 123},
        connection: :redis,
        delay: :timer.hours(24))

      # Add a job with retries
      {:ok, job} = EchoMQ.Queue.add("payments", "process", %{amount: 100},
        connection: :redis,
        attempts: 5,
  ...
  ## Examples
      ...
      {:ok, added_jobs} = EchoMQ.Queue.add_bulk("emails", jobs, connection: :redis)
      ...
      {:ok, jobs} = EchoMQ.Queue.add_bulk("emails", large_job_list,
        connection: :redis,
      ...
      {:ok, jobs} = EchoMQ.Queue.add_bulk("emails", jobs,
        connection: :redis,
        pipeline: false
      )
  ...
  ## Examples
      ...
      {:ok, job} = EchoMQ.Queue.get_job("my_queue", "123", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, :waiting} = EchoMQ.Queue.get_job_state("my_queue", "123", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, counts} = EchoMQ.Queue.get_counts("my_queue", connection: :redis)
      # %{waiting: 10, active: 2, delayed: 5, completed: 100, failed: 3}
  """
  ...
  ## Examples
      ...
      {:ok, count} = EchoMQ.Queue.count("my_queue", connection: :redis)
      # 15
  """
  ...
  ## Examples
      ...
      {:ok, counts} = EchoMQ.Queue.get_job_counts("my_queue", [:waiting, :completed], connection: :redis)
  ...
  ## Examples
      ...
      {:ok, total} = EchoMQ.Queue.get_job_count_by_types("my_queue", [:waiting, :delayed], connection: :redis)
      # 25
  """
  ...
  ## Examples
      ...
      {:ok, meta} = EchoMQ.Queue.get_meta("my_queue", connection: :redis)
  ...
  @doc """
  Gets the EchoMQ version stored in the queue's metadata.

  This version indicates the Lua script version/capabilities of the queue,
  which corresponds to the Node.js EchoMQ version. This is important for
  ...
  ## Examples
      ...
      {:ok, version} = EchoMQ.Queue.get_version("my_queue", connection: :redis)
      # "bullmq:5.65.1"

  ## See Also

    * `EchoMQ.Version` - Module containing the EchoMQ version constants
  """
  ...
  ## Examples
      ...
      :ok = EchoMQ.Queue.update_meta("my_queue", connection: :redis)
      :ok = EchoMQ.Queue.update_meta("my_queue", connection: :redis, max_len_events: 50_000)

  ## See Also

    * `EchoMQ.Version` - The EchoMQ version that will be set
  """
  ...
  ## Examples
      ...
      {:ok, jobs} = EchoMQ.Queue.get_jobs("my_queue", :waiting, connection: :redis)
      {:ok, jobs} = EchoMQ.Queue.get_jobs("my_queue", [:waiting, :active], connection: :redis)
      {:ok, jobs} = EchoMQ.Queue.get_jobs("my_queue", :failed, connection: :redis, start: 0, end: 9)
  """
  ...
  ## Examples
      ...
      {:ok, jobs} = EchoMQ.Queue.get_waiting("my_queue", connection: :redis)
      {:ok, jobs} = EchoMQ.Queue.get_waiting("my_queue", connection: :redis, start: 0, end: 9)
  """
  ...
  ## Examples
      ...
      {:ok, jobs} = EchoMQ.Queue.get_waiting_children("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, jobs} = EchoMQ.Queue.get_active("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, jobs} = EchoMQ.Queue.get_delayed("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, jobs} = EchoMQ.Queue.get_prioritized("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, jobs} = EchoMQ.Queue.get_completed("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, jobs} = EchoMQ.Queue.get_failed("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, count} = EchoMQ.Queue.get_completed_count("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, count} = EchoMQ.Queue.get_failed_count("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, count} = EchoMQ.Queue.get_delayed_count("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, count} = EchoMQ.Queue.get_active_count("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, count} = EchoMQ.Queue.get_prioritized_count("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, count} = EchoMQ.Queue.get_waiting_count("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, count} = EchoMQ.Queue.get_waiting_children_count("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, concurrency} = EchoMQ.Queue.get_global_concurrency("my_queue", connection: :redis)
      # {:ok, 10} or {:ok, nil}
  """
  ...
  ## Examples
      ...
      {:ok, rate_limit} = EchoMQ.Queue.get_global_rate_limit("my_queue", connection: :redis)
  ...
  ## Examples
      ...
      {:ok, ttl} = EchoMQ.Queue.get_rate_limit_ttl("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, job_id} = EchoMQ.Queue.get_deduplication_job_id("my_queue", "dedup-123", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, 1} = EchoMQ.Queue.remove_deduplication_key("my_queue", "dedup-123", connection: :redis)

      # Key doesn't exist
      {:ok, 0} = EchoMQ.Queue.remove_deduplication_key("my_queue", "unknown", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, %{logs: logs, count: count}} = EchoMQ.Queue.get_job_logs("my_queue", "123", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, metrics} = EchoMQ.Queue.get_metrics("my_queue", :completed, connection: :redis)
      # %{
  ...
  ## Examples
      ...
      {:ok, workers} = EchoMQ.Queue.get_workers("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, count} = EchoMQ.Queue.get_workers_count("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, metrics} = EchoMQ.Queue.export_prometheus_metrics("my_queue", connection: :redis)
      # "# HELP bullmq_job_count Number of jobs in the queue by state\\n..."

      {:ok, metrics} = EchoMQ.Queue.export_prometheus_metrics("my_queue",
        connection: :redis,
  ...
  ## Examples
      ...
      :ok = EchoMQ.Queue.pause("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      :ok = EchoMQ.Queue.resume("my_queue", connection: :redis)
  """
  ...
  ## Examples
      ...
      :ok = EchoMQ.Queue.drain("my_queue", connection: :redis)
      :ok = EchoMQ.Queue.drain("my_queue", connection: :redis, delayed: true)
  """
  ...
  ## Examples
      ...
      :ok = EchoMQ.Queue.obliterate("my_queue", connection: :redis)
      :ok = EchoMQ.Queue.obliterate("my_queue", force: true, connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, 1} = EchoMQ.Queue.remove_job("my_queue", "123", connection: :redis)
  """
  ...
  ## Examples
      ...
      :ok = EchoMQ.Queue.retry_job("my_queue", "123", connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, cleaned_ids} = EchoMQ.Queue.clean("my_queue", :completed, 3600_000, connection: :redis)
  """
  ...
  ## Examples
      ...
      {:ok, pid} = EchoMQ.Queue.start_link(
        name: :my_queue,
        queue: "my_queue",
        connection: :my_redis
      )
  ...
  defp add_job_with_telemetry(state, job) do
    ...
    span_opts = [
      ...
      attributes: %{
        ...
        "echomq.job.id" => job.id,
        "echomq.job.priority" => job.priority,
        "echomq.job.delay" => job.delay
      }
    ]

    span = telemetry_mod.start_span("echomq.queue.add", span_opts)
