defmodule EchoStore.Durability.Memory do
  @moduledoc "An in-memory (Agent/ETS) outbox for tests — no infrastructure, no durability."
  ...
  def child_spec(opts),
    do: %{id: opts[:name] || __MODULE__, start: {__MODULE__, :start_link, [opts]}}
