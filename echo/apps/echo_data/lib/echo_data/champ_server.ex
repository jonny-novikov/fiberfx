defmodule EchoData.ChampServer do
  @moduledoc """
  GenServer wrapper for BrandedChamp providing stateful access.
  ...
  add features like persistence or expiration.
  ...
  @type id :: BrandedChamp.branded_id()
  @type value :: BrandedChamp.value()
  ...
  """
  @spec get_namespace(server(), BrandedChamp.namespace()) :: [{id(), value()}]
  ...
  """
  @spec namespace_size(server(), BrandedChamp.namespace()) :: non_neg_integer()
  ...
  """
  @spec namespaces(server()) :: [BrandedChamp.namespace()]
