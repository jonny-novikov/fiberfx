...
var (
	version   = "0.1.0"
	distrDir  = "/app/distr"
	indexHTML = "/app/html/index.html"
	egeDir    = "/app/html/ege"
	eduDir    = "/app/html/edu"
	schoolDir = "/app/html/school"
	futureDir = "/app/html/future"
	mapDir    = "/app/html/map"
	...
	physicsDir = "/app/html/physics"
	// AI-at-work course content («ИИ на работе: считать, проверять, автоматизировать») —
	// FOLDER-routed like the other courses (chapters are dirs, modules are files
...
func main() {
	...
	// Folder-routed sections: /elixir, /health, /logic, /law, /physics and /ai-rabota each map a clean URL to a
	...
	//   /ai-rabota/promt                → ai-rabota/promt/index.html           (chapter dir)
...
// path separator right after dir, so a sibling like "/app/html/egevil" cannot pass as
// being under "/app/html/ege".
