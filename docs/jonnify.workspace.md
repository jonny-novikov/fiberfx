...
|---|---|---|
| **`echo/`** | The **Elixir/Mix umbrella** — the BCS data plane (`echo_wire` · `echo_data` · `echo_mq` · `echo_cache`, Valkey-native on ETS + Lua) + consumers (`exchange`, `investex`, `echo_bot`, `codemoji`). Engine: Valkey 9 on `:6390`. | [`echo/CLAUDE.md`](../echo/CLAUDE.md) (build guide) + [`echo/README.md`](../echo/README.md); specs `docs/echo_mq/` |
