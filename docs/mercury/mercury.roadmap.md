...
| ↳ **mx.9.4** | III | the **contract surface** — the ported zero-dep compact markdown renderer; Docs = the full `.prompt.md`, API = `## Props`, do/don't = `## The enum language` + `## Notes` (the 56/65 census — a missing section renders EMPTY), recipes = `## Examples` · epic S-6/S-7/INV-5 · NORMAL/Trio | 📋 PLANNED (SOLID-FORWARD triad, re-sharpened at ship) ([`specs/mx.9.4/mx.9.4.md`](./specs/mx.9.4/mx.9.4.md)) |
