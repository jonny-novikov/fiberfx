...
| ↳ **mx.9.5** | III | the **closer** — the seed-skinned chrome (Fork C Arm C, token-expressed), the dual-theme acceptance (epic S-8 full; the `--indigo-3` soft-bg limitation EXPECTED, logged upstream), the whole-epic INV-1..9 + S-9/S-10 re-run — **Movement III closes** · ELEVATED closer/**Squad + Apollo** | 📋 PLANNED (SOLID-FORWARD triad, re-sharpened at ship) ([`specs/mx.9.5/mx.9.5.md`](./specs/mx.9.5/mx.9.5.md)) |
