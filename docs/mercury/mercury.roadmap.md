...
| ↳ **mx.8.2+** | III | the remaining groups' variant/actions audit + scenes (`actions` activates on the interactive groups — `actions · inputs · selection · feedback · data-display · navigation · overlay`), sliced as `mx.7.4/7.5` land the full library | 📋 PLANNED |
