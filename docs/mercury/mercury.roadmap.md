...
| ↳ **mx.9.2** | III | the **derived registry + shell** — two lazy `import.meta.glob`s over the real component tree (INV-6), the grouped sidebar + topbar, the persisted route, Stories/Docs tab stubs, the theme-toggle mechanism · epic INV-4/6 · NORMAL/Trio | 📋 PLANNED (BUILD-READY triad authored 2026-07-02) ([`specs/mx.9.2/mx.9.2.md`](./specs/mx.9.2/mx.9.2.md)) |
