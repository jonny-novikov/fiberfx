...
probes run twice, a behavioral mutation on the merge law caught by the sweep itself) — **the frontier is
`mx.9.4` (the contract surface) — parallel-safe with nothing else open in the epic; mx.9.5 closes**. Forward
