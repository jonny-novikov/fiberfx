...
vite 6→7 + pnpm `catalog:` toolchain lift — SPECCED) or `mx.8.3+` (the remaining Storybook enrichment
...
Movement III · the Design System Storybook   (laddered behind mx.2 — each story writes its controls from the contract)
  ...
  mx.9   ✅ BUILT     ████████████████████  ONE comprehensive showcase app (library · docs · API · do/don't · recipes) — 9.1–9.5 all BUILT 2026-07-02 (layered-engine axis; forks A–E RULED; Squad+Apollo closer) — Movement III CLOSES
