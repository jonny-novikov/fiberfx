...
CommonMark-faithful hygiene residual) — **the frontier is `mx.9.5` (the closer: chrome + dual-theme +
whole-epic acceptance; ELEVATED — Squad + Apollo; Movement III closes)**. Forward
