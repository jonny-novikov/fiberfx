...
one audience and one purpose. The real triad to map is `f6.1.{md,stories.md,llms.md}` — the spec for the Portal's
first web rung. The second triad, fittingly, is the course's own `a4.{md,stories.md,llms.md}`: this chapter is a
worked example of the artifact it teaches.
