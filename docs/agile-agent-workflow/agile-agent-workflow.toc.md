...
This course teaches a way of working — codified, one altitude up, as the **AAW framework**
([the definition](../aaw/aaw.framework.md) · [the rules](../aaw/aaw.rules.md)), whose rules describe the shipped
practice rather than impose a methodology. Its claim is simple: a human who supplies judgment, taste, and
...
- Schwaber & Sutherland, *The Scrum Guide* — <https://scrumguides.org/>.
