...
emq.2 in one line: the v1→v2 migration path RE-PROVEN against echo_mq (program hygiene — retires the push source's deployments so apps/echomq dissolves; NO TRD rung gates on it, recorded not asserted).
