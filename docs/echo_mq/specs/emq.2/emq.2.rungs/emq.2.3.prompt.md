...
> the spec triad ([`./emq.2.3.md`](emq.2.3.md) · [`./emq.2.3.stories.md`](emq.2.3.stories.md) ·
> [`./emq.2.3.llms.md`](emq.2.3.llms.md)), the carve ADR, and the canon ([`../emq.design.md`](../../../emq.design.md)).
...
no clock. (c) Build EMQ.2.3-D2 → D7 to [`./emq.2.3.llms.md`](emq.2.3.llms.md)'s agent stories — the
...
docs/echo_mq/specs/emq.2.3.llms.md
...
The brief: [`./emq.2.3.llms.md`](emq.2.3.llms.md). The carve it closes:
