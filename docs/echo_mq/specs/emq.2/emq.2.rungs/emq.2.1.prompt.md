...
> inputs are the spec triad ([`./emq.2.1.md`](emq.2.1.md) · [`./emq.2.1.stories.md`](emq.2.1.stories.md)
> · [`./emq.2.1.llms.md`](emq.2.1.llms.md)), the carve ADR, and the canon ([`../emq.design.md`](../../../emq.design.md)).
...
EMQ.2.1-D2 → D7 to [`./emq.2.1.llms.md`](emq.2.1.llms.md)'s agent stories — counts over the as-built
...
docs/echo_mq/specs/emq.2.1.llms.md
...
The brief: [`./emq.2.1.llms.md`](emq.2.1.llms.md). The carve it opens:
