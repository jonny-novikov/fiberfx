...
The old emq.2 triad (`emq.2.md` + `.stories.md` + `.llms.md` + `.prompt.md`) is **re-purposed**: this run
...
[`./emq.2.3.md`](emq.2.rungs/emq.2.3.md) (each with `.stories.md` / `.llms.md` / `.prompt.md`). The precedent
