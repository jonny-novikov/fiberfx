...
> per-sub-rung acceptance lives in each sub-rung's `.stories.md` (emq.3.1 first — [`./emq.3.1.stories.md`](./emq.3/emq.3.1.stories.md)).
...
The per-sub-rung Deliverables (emq.3.1's D1–Dn) trace in [`./emq.3.1.stories.md`](./emq.3/emq.3.1.stories.md); this
