...
is the single consolidated [`emq.roadmap.md`](../emq.roadmap.md); the next major is specified in [`emq.streams.md`](../emq.streams.md).
...
([`emq.streams.md`](../emq.streams.md)) stands on this line's wire and the store's durable `Graft` engine. The courses teach from the rungs'
...
[`emq.streams.md`](../emq.streams.md) · [`emq.roadmap.md` §EchoMQ 3.x](../emq.roadmap.md). The records this line carries: [`bcs.toc.md`](../../echo/bcs/bcs.toc.md) — the lanes, the
