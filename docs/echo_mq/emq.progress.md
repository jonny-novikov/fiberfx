...
**52/52**. **Movement II (emq.4–emq.8) opens on a complete core.** The build team is echo_mq-specialized (the
...
Movement II · the extension family
  emq.4     📋 planned     ░░░░░░░░░░░░░░░░░░░░  groups deepened (4.1–4.4; basics shipped in the foundation as EchoMQ.Lanes)
...
── roll-up ──
  ...
  planned     emq.4 (→4.1–4.4) · emq.5 · emq.6 · emq.7 · emq.8
  ───────────────────────────────────────────
