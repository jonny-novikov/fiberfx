...
- **When.** The foundation is **established** (`emq.0`). **Movement I is CLOSED** (emq.1 · the emq.2
  ...
  **the emq.4 groups family is CLOSED** (4.1–4.4, conformance **61**) and **emq.5 (batches) is CLOSED**
  ...
  continuation"** (Operator-revisable, not deleted). **emq3.1 (the stream-verb floor · conf 74 · `7b44dc97`) SHIPPED; emq3.2 (the writer law) is next.**
...
| **emq3.1–emq3.6** | **3.0** | **EchoMQ 3.0 — the Stream Tier** (S1 writer → S2 readers → S3 memory); ships additive-minor, the `echomq:3.0.0` major a deferred cutover ratification | 🔨 **IN FLIGHT** — **emq3.1 SHIPPED** (the verb floor · conf 74 · `7b44dc97`); **emq3.2 next** (the writer law); gated on emq.0 (met) ([`emq.streams.md`](./emq.streams.md)) |
