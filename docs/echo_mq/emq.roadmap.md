...
- **When.** The foundation is **established** (`emq.0`). **Movement I is CLOSED** (emq.1 · the emq.2
  ...
  **the emq.4 groups family is CLOSED** (4.1–4.4, conformance **61**) and **emq.5 (batches) is CLOSED**
  ...
  continuation"** (Operator-revisable, not deleted). **emq3.1–emq3.2 (S1 the writer) SHIPPED — the stream-verb floor + the writer law (`EchoMQ.Stream`, conf 75, `b6ff483b`); emq3.3 (S2 the readers) is next.**
...
| **emq3.1–emq3.6** | **3.0** | **EchoMQ 3.0 — the Stream Tier** (S1 writer → S2 readers → S3 memory); ships additive-minor, the `echomq:3.0.0` major a deferred cutover ratification | 🔨 **IN FLIGHT** — **emq3.1–3.2 SHIPPED** (S1 the writer: the verb floor `7b44dc97` + the writer law conf 75 `b6ff483b`); **emq3.3 next** (S2 the readers); gated on emq.0 (met) ([`emq.streams.md`](./emq.streams.md)) |
