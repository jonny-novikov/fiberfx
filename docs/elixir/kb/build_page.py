...
MODULES = {
    ...
    "F4": [
        ...
        dict(n="F4.07", title="Identifiers, Snowflake & branded ids", one="From naive ids to a Snowflake bigint and a branded, base62 id.", slug="identifiers", status="planned", lab=False),
