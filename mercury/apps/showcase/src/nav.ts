...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { route: "components/link", label: "Link" },
      ...
      { route: "components/divider", label: "Divider" },
  ...
  },
  {
    ...
    items: [
      ...
      { route: "patterns/auth", label: "Auth flow" },
...
export const OVERVIEW_CARDS: OverviewCard[] = [
  ...
  { route: "components/link", title: "Link", desc: "Inline link or button affordance with icon slots." },
  ...
  { route: "components/divider", title: "Divider", desc: "Plain, labelled “or”, and vertical rules." },
  ...
  { route: "patterns/auth", title: "Auth flow", desc: "Five screens on one AuthLayout, driven by Effector." },
