...
- **Pairs with:** Calendar — the popover month-grid picker (planned **mx.7.3.2**); DateField is the typed
  text entry, Calendar the pointer-driven one. *(The cross-link resolves when that contract ships.)*
