...
Owed (pending tasks): `mcp/docs/figma-local.md` agent usage instructions; scoped figma-local pointers in 3 CLAUDE.md files; CODEMOJIES design spec into `@codemoji/design`; post-deploy test.
