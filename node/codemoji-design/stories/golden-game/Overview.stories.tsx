...
// Golden Game is the gameplay board with a gold treatment: StatusBar / EmojiSlots
// / GuessActions / EmojiKeyboard / BoardTabs / GameRules / ShareKeys are REUSED
// from the board; GoldenHero / GoldenAnswerReveal / GoldenLeaderboard are the
// golden-specific surfaces. Static sample data; live theming still applies.

const STANDINGS: GoldenStanding[] = [
...
function StandingsCard() {
  return (
    <BoardCard>
      <BoardTabs>
        <GoldenLeaderboard items={STANDINGS} />
      </BoardTabs>
    </BoardCard>
  );
}
...
function FinishedBoard() {
  return (
    <Frame>
      ...
      <GoldenAnswerReveal code={ANSWER} />
...
type Story = StoryObj;
export const InProgress: Story = { name: 'In progress', render: () => <InProgressBoard /> };
export const Finished: Story = { render: () => <FinishedBoard /> };
