...
// The whole gameplay board (94:2974) assembled from the design system's board
// components, top to bottom as the screen reads. Every block here IS one of the
// Board/* components; this composition is the proof they assemble into the real
// screen. Static sample data; the live theming (the purchase CTA, the active tab
// + the score bars) recolors with the ▸ Theme toolbar.
//
